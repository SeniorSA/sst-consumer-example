...
public class LoginMFAInfo {
     ...
     */
    public String temporaryToken; //NOSONAR
    /**
     ...
     */
    public UserOTPAuthStatusDTO mfaStatus; //NOSONAR
    /**
     * Nome do tenant
     */
    public String tenant; //NOSONAR
    ...
    public boolean equals(Object obj) {
        ...
        if ((tenant != null) && !tenant.equals(other.tenant)) { //NOSONAR
            return false;
        }
        return true;
    }
