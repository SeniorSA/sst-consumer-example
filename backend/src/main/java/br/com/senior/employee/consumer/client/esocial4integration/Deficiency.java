...
public class Deficiency {
     ...
     */
    public DeficiencyType deficiencyType; //NOSONAR
     ...
     */
    public Deficiency(String id, Long code, String name, Boolean isMainDeficiency, DeficiencyType deficiencyType) {
        this.id = id;
        this.code = code;
        this.name = name;
     ...
     */
    public Deficiency(Long code, String name, Boolean isMainDeficiency, DeficiencyType deficiencyType) {
        this.code = code;
        this.name = name;
        this.isMainDeficiency = isMainDeficiency;
        this.deficiencyType = deficiencyType;
